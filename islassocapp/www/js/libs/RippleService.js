(function() {
    ...
    Ext.define('Jda.ISL.Libs.RippleService', {
        //singleton: true,
        ...
        attach: function attach(scope, element, options) {
            ...
            function createRipple(left, top) {
                 ...
                 * If there is no ripple container, it creates one and returnsÓ it
                 *
        ...
        // console.log('In ripple service');
        // RippleService = new Jda.ISL.Libs.RippleService();
        // console.log(RippleService);
    });
}());

 ...
 * the help of #{RippleService}
 * */
Ext.define('Jda.ISL.override.Button', {
    override: 'Ext.Button',
    xtype: 'button',
    ...
    requires: [
        //'Jda.ISL.Utils.RippleService'
    ],

    initialize: function() {
        this.callParent();
        //var rippleService = ISL.app.RippleService;
        var rippleService = new Jda.ISL.Libs.RippleService();
